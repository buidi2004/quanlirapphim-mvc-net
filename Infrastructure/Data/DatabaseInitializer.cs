...
public static class DatabaseInitializer
{
    ...
    private static void SeedData(IDbConnection db)
    {
        ...
        db.Execute("""
            ...
            ('Khai Trương Rạp Mới – Giảm 50% Toàn Bộ Vé', 'CinemaX Mega Mall chính thức hoạt động từ 01/08. Ưu đãi giảm 50% toàn bộ vé tuần lễ khai trương!', 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?q=80&w=1200&auto=format&fit=crop', '/cinemas', 1, 1),
            ('Combo Hè Sảng Khoái – Chỉ 99K', 'Mua combo bắp nước đặc biệt mùa hè chỉ với 99.000đ. Áp dụng tất cả các rạp CinemaX.', 'https://images.unsplash.com/photo-1585647347483-22b66260dfff?q=80&w=1200&auto=format&fit=crop', '/concession', 2, 1),
            ('Thứ 3 Vui Vẻ – Đồng Giá 45K', 'Mỗi thứ 3 hàng tuần, tất cả vé xem phim 2D chỉ 45.000đ. Đặt vé ngay!', 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?q=80&w=1200&auto=format&fit=crop', '/promotions', 3, 1),
            ('Trải Nghiệm IMAX Laser – Đỉnh Cao Hình Ảnh', 'Xem phim trên màn hình IMAX Laser khổng lồ với chất lượng hình ảnh 4K sắc nét. Trải nghiệm điện ảnh tối thượng.', 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=1200&auto=format&fit=crop', '/experiences/imax', 4, 1),
            ('Tích Điểm Đổi Vé Miễn Phí', 'Đăng ký thành viên CinemaX Club, tích điểm mỗi lần xem phim và đổi vé miễn phí. Tham gia ngay!', 'https://images.unsplash.com/photo-1594909122845-11baa439b7bf?q=80&w=1200&auto=format&fit=crop', '/register', 5, 1);
        """);
    }
}
