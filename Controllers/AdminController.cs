...
[Route("admin")]
public class AdminController(IMovieService movieService, IAuditLogService auditLogService, IDashboardService dashboardService, IShowtimeService showtimeService) : Controller
{
    // GET /admin
    [HttpGet("")]
